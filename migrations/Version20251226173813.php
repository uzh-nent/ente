 ...
 */
final class Version20251226173813 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE inf_report (id CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', probe_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:guid)\', leading_code_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:guid)\', organism_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:guid)\', specimen_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:guid)\', created_by_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:guid)\', last_changed_by_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:guid)\', interpretation VARCHAR(255) DEFAULT NULL, sent_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', document_id VARCHAR(255) DEFAULT NULL, payload JSON DEFAULT NULL COMMENT \'(DC2Type:json)\', response JSON DEFAULT NULL COMMENT \'(DC2Type:json)\', api_id VARCHAR(255) DEFAULT NULL, api_status VARCHAR(255) NOT NULL, INDEX IDX_EC2DFBBF3D2D0D4A (probe_id), INDEX IDX_EC2DFBBFCA52EA18 (leading_code_id), INDEX IDX_EC2DFBBF64180A36 (organism_id), INDEX IDX_EC2DFBBFBF112A8 (specimen_id), INDEX IDX_EC2DFBBFB03A8386 (created_by_id), INDEX IDX_EC2DFBBFEE85B337 (last_changed_by_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE observation (id CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', organism_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:guid)\', probe_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:guid)\', created_by_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:guid)\', last_changed_by_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:guid)\', analysis_type VARCHAR(255) NOT NULL, analysis_stop_at DATE DEFAULT NULL COMMENT \'(DC2Type:date_immutable)\', interpretation VARCHAR(255) DEFAULT NULL, interpretation_text VARCHAR(255) DEFAULT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', last_changed_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', comment LONGTEXT DEFAULT NULL, INDEX IDX_C576DBE064180A36 (organism_id), INDEX IDX_C576DBE03D2D0D4A (probe_id), INDEX IDX_C576DBE0B03A8386 (created_by_id), INDEX IDX_C576DBE0EE85B337 (last_changed_by_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE organism (id CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', organism_group VARCHAR(255) DEFAULT NULL, pathogen VARCHAR(255) DEFAULT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', last_changed_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', system VARCHAR(255) DEFAULT NULL, code VARCHAR(255) DEFAULT NULL, display_name VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE patient (id CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', gender LONGTEXT DEFAULT NULL, birth_date DATE DEFAULT NULL COMMENT \'(DC2Type:date_immutable)\', ahv_number VARCHAR(255) DEFAULT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', last_changed_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', given_name VARCHAR(255) DEFAULT NULL, family_name VARCHAR(255) DEFAULT NULL, address_lines LONGTEXT DEFAULT NULL, city VARCHAR(255) DEFAULT NULL, postal_code VARCHAR(255) DEFAULT NULL, country_code VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE probe (id CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', created_by_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:guid)\', last_changed_by_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:guid)\', orderer_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:guid)\', animal_keeper_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:guid)\', patient_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:guid)\', specimen_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:guid)\', identifier VARCHAR(255) NOT NULL, status VARCHAR(255) DEFAULT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', last_changed_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', comment LONGTEXT DEFAULT NULL, laboratory_function VARCHAR(255) DEFAULT NULL, pathogen VARCHAR(255) DEFAULT NULL, pathogen_name VARCHAR(255) DEFAULT NULL, analysis_types LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:simple_array)\', orderer_identifier VARCHAR(255) DEFAULT NULL, orderer_name VARCHAR(255) DEFAULT NULL, orderer_address_lines LONGTEXT DEFAULT NULL, orderer_city VARCHAR(255) DEFAULT NULL, orderer_postal_code VARCHAR(255) DEFAULT NULL, orderer_country_code VARCHAR(255) DEFAULT NULL, orderer_contact LONGTEXT DEFAULT NULL, specimen_date DATE DEFAULT NULL COMMENT \'(DC2Type:date_immutable)\', specimen_source VARCHAR(255) DEFAULT NULL, specimen_source_text VARCHAR(255) DEFAULT NULL, specimen_text VARCHAR(255) DEFAULT NULL, specimen_type_text VARCHAR(255) DEFAULT NULL, specimen_location VARCHAR(255) DEFAULT NULL, specimen_food_type VARCHAR(255) DEFAULT NULL, specimen_animal_type VARCHAR(255) DEFAULT NULL, animal_name VARCHAR(255) DEFAULT NULL, specimen_isolate TINYINT(1) DEFAULT NULL, animal_keeper_name VARCHAR(255) DEFAULT NULL, animal_keeper_address_lines LONGTEXT DEFAULT NULL, animal_keeper_city VARCHAR(255) DEFAULT NULL, animal_keeper_postal_code VARCHAR(255) DEFAULT NULL, animal_keeper_country_code VARCHAR(255) DEFAULT NULL, patient_birth_date DATE DEFAULT NULL COMMENT \'(DC2Type:date_immutable)\', patient_ahv_number VARCHAR(255) DEFAULT NULL, patient_given_name VARCHAR(255) DEFAULT NULL, patient_family_name VARCHAR(255) DEFAULT NULL, patient_address_lines LONGTEXT DEFAULT NULL, patient_city VARCHAR(255) DEFAULT NULL, patient_postal_code VARCHAR(255) DEFAULT NULL, patient_country_code VARCHAR(255) DEFAULT NULL, received_at DATE NOT NULL COMMENT \'(DC2Type:date_immutable)\', analysis_start_at DATE DEFAULT NULL COMMENT \'(DC2Type:date_immutable)\', finished_at DATE DEFAULT NULL COMMENT \'(DC2Type:date_immutable)\', UNIQUE INDEX UNIQ_D75E6F2A772E836A (identifier), INDEX IDX_D75E6F2AB03A8386 (created_by_id), INDEX IDX_D75E6F2AEE85B337 (last_changed_by_id), INDEX IDX_D75E6F2ADF123119 (orderer_id), INDEX IDX_D75E6F2A83D86AEC (animal_keeper_id), INDEX IDX_D75E6F2A6B899279 (patient_id), INDEX IDX_D75E6F2ABF112A8 (specimen_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE specimen (id CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', specimen_group VARCHAR(255) DEFAULT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', last_changed_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', system VARCHAR(255) DEFAULT NULL, code VARCHAR(255) DEFAULT NULL, display_name VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
