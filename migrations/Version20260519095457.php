 ...
 */
final class Version20260519095457 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE report_email (id CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', probe_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:guid)\', report_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:guid)\', created_by_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:guid)\', last_changed_by_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:guid)\', receivers VARCHAR(255) NOT NULL, cc_receivers VARCHAR(255) DEFAULT NULL, subject VARCHAR(255) NOT NULL, body LONGTEXT NOT NULL, sent_at DATE DEFAULT NULL COMMENT \'(DC2Type:date_immutable)\', created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', last_changed_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_CD8E7B0D3D2D0D4A (probe_id), INDEX IDX_CD8E7B0D4BD2A4C0 (report_id), INDEX IDX_CD8E7B0DB03A8386 (created_by_id), INDEX IDX_CD8E7B0DEE85B337 (last_changed_by_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
