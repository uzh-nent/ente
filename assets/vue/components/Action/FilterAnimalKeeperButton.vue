<template>
  <button-confirm-modal
    :title="$t('_action.filter_animal_keeper.title')" icon="fas fa-filter" button-size="sm"
    ...
    <animal-keeper-filter-form :template="template" @update="filter = $event" />
  </button-confirm-modal>
</template>
...
import AnimalKeeperFilterForm from "../Form/AnimalKeeperFilterForm.vue";

export default {
  components: {
    AnimalKeeperFilterForm,
    ButtonConfirmModal,
  },
  mixins: [filterAction],
  methods: {
