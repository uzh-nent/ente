...
<script>
/**
 * Source: https://github.com/MdUsmanAnsari/walking-duck-animation
 * MIT licensed
 */
export default {}
</script>
...
.duck__body::after {
  ...
  left: 50%;
  top: -95%;
  -webkit-transform: translate(-50%, 0.02em) rotate(-6deg);
  transform: translate(-50%, 0.02em) rotate(-6deg);
  border-radius: 50%;
  border-bottom: 1em solid var(--color-light-orange-2);
}
